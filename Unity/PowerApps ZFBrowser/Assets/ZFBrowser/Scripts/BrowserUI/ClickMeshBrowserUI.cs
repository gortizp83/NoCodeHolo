...
public class ClickMeshBrowserUI : MonoBehaviour, IBrowserUI {
	...
	protected virtual Ray LookRay {
            ...
            // f that line above me lets try drawing our own ray cast

            get {
                return new Ray();
                // public Ray(Vector3 origin, Vector3 direction);
                //return new Ray(VRInputManager.GetHand(VRHandSide.Right).position, VRInputManager.GetHand(VRHandSide.Right).GetForward()
            }
        }
	...
	public virtual void InputUpdate() {
		...
		//if (VRInputManager.GetButton(VRHandSide.Right, VRButtonType.Trigger)) buttons |= MouseButton.Left;
		...
		MouseButtons = buttons;
            ...
            //MouseScroll = new Vector2 (VRInputManager.GetAxisValue(VRHandSide.Right, VRAxisType.Horizontal)*-2, VRInputManager.GetAxisValue(VRHandSide.Right, VRAxisType.Vertical)*-2);
